...
//系统通用js
document.write('<script src="' + bootPATH + 'comm.js" type="text/javascript" ></sc' + 'ript>');

document.write('<link href="' + bootPATH + 'miniui/themes/default/miniui.css" rel="stylesheet" type="text/css" />');
document.write('<link href="' + bootPATH + 'miniui/themes/icons.css" rel="stylesheet" type="text/css" />');
//系统定义css
document.write('<link rel="stylesheet" type="text/css" href="/style/theme.css" />');


//skin
var skin = "custom"//getCookie("miniuiSkin");
if (skin) {
