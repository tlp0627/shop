...
<script>
	...
	function  checkCode(){
		var ck_img = document.getElementById("checkImg");
		ck_img.src="${pageContext.request.contextPath}/checkImgAction.action?"+new Date().getTime();
	}
</script>
</head>
<body>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath }/User_regist1.action" method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								<th>
								...
								<td>
									<input type="text" id="username" name="username" class="text" maxlength="20" onblur="checkUser()">
									<span id="span1"></span>
								</td>
							</tr>
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											...
											<img id="checkImg"  class="captchaImage" src="{pageContext.requst.contextPath}/checkImgAction.action" onclick="checkCode()" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
